package froztigaming.arrowsplus.utils;
    ...
    public static void travel(LivingEntity entity, int option) {
        ...
        if (!entity.world.isClient) {
            ...
            if (serverWorld != null && server.isNetherAllowed()) {
                ...
                if (option == 1)
                {
                    entity.world.playSound(null, entity.getBlockPos(), SoundEvents.BLOCK_PORTAL_TRAVEL, SoundCategory.NEUTRAL, 0.5F, 1);
                }
                if (option == 2)
                {
                    entity.world.playSound(null, entity.getBlockPos(), SoundEvents.BLOCK_END_PORTAL_SPAWN, SoundCategory.NEUTRAL, 0.5F, 1);
                }
                ...
                if (option == 1)
                {
                    serverWorld.playSound(null, entity.getBlockPos(), SoundEvents.BLOCK_PORTAL_TRAVEL, SoundCategory.NEUTRAL, 0.5F, 1);
                }
                if (option == 2)
                {
                    serverWorld.playSound(null, entity.getBlockPos(), SoundEvents.BLOCK_END_PORTAL_SPAWN, SoundCategory.NEUTRAL, 0.5F, 1);
                }
            }
        }
    }
